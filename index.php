...
<!-- Hero Section -->
<section class="bg-primary-light dark:bg-primary-dark text-white py-12 md:py-16 px-4 md:px-8 rounded-lg shadow-lg mb-8">
        ...
        <div class="flex flex-col md:flex-row items-center">
            <div class="md:w-1/2 mb-8 md:mb-0 md:pr-6">
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    <a href="<?php echo $base_url; ?>register.php" class="bg-white dark:bg-primary-dark/80 text-primary-light dark:text-white font-bold px-6 py-3 rounded-md hover:bg-gray-100 dark:hover:bg-primary-dark transition text-center shadow-md">Register as Donor</a>
                    <a href="<?php echo $base_url; ?>request.php" class="border-2 border-white dark:border-gray-300 text-white font-semibold px-6 py-3 rounded-md hover:bg-primary-dark/80 dark:hover:bg-primary-dark/90 transition text-center shadow-md">Request Blood</a>
                </div>
            </div>
            <div class="md:w-1/2">
...
.stats-section .glow-icon-container {
  ...
  background-color: rgba(99, 102, 241, 0.15); /* Indigo-based background */
  animation: glow-pulse 1.2s infinite ease-in-out;
}

.dark .stats-section .glow-icon-container {
  background-color: rgba(79, 70, 229, 0.2); /* Darker indigo in dark mode */
}
...
.glow-icon-container:hover .glow-icon {
...
.card:hover {
  ...
  box-shadow: 0 8px 25px rgba(99, 102, 241, 0.2); /* Indigo shadow */
}
...
.card::before {
  ...
  width: 100%;
  height: 100%;
  background: linear-gradient(135deg, rgba(99, 102, 241, 0.1) 0%, transparent 50%); /* Indigo gradient */
  z-index: -1;
...
:root {
  ...
  --primary-lighter: #EEF2FF; /* Light indigo bg */
}
</style>
...
<section class="py-10 md:py-12 bg-white dark:bg-gray-800">
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            ...
            foreach ($bloodTypes as $type => $info) {
                echo '<div class="card animate-on-scroll dark-card p-5" style="transition-delay: ' . $delay . 'ms;">';
                echo '<div class="text-center mb-3">';
                echo '<span class="inline-block bg-primary-lighter dark:bg-primary-dark/20 text-primary-dark dark:text-primary-light text-2xl font-bold px-4 py-1.5 rounded-full">' . $type . '</span>';
                echo '</div>';
                echo '<p class="mb-2 font-semibold dark:text-white text-xs uppercase tracking-wide">Can Donate To:</p>';
                echo '<p class="dark:text-gray-300 text-sm mb-3">' . htmlspecialchars($info[0]) . '</p>';
                echo '<p class="mb-2 font-semibold dark:text-white text-xs uppercase tracking-wide">Can Receive From:</p>';
                echo '<p class="dark:text-gray-300 text-sm">' . htmlspecialchars($info[1]) . '</p>';
                echo '</div>';
                $delay += 50;
            }
            ?>
        </div>
        <p class="text-center mt-4 text-sm text-gray-600 dark:text-gray-400">Compatibility shown is for Red Blood Cells (RBCs). Plasma compatibility differs.</p>
    </div>
</section>

<!-- Why Donate Section -->
<section id="why-donate" class="py-16 bg-gradient-to-b from-white to-gray-50 dark:from-gray-800 dark:to-gray-900">
    <div class="container mx-auto px-4">
                ...
                <div class="space-y-5">
                    <div>
                        ...
                        <div class="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-2.5">
                            <div class="bg-primary-light dark:bg-primary-dark h-2.5 rounded-full" style="width: 34%"></div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-2.5">
                            <div class="bg-primary-light dark:bg-primary-dark h-2.5 rounded-full" style="width: 25%"></div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-2.5">
                            <div class="bg-primary-light dark:bg-primary-dark h-2.5 rounded-full" style="width: 18%"></div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-2.5">
                            <div class="bg-primary-light dark:bg-primary-dark h-2.5 rounded-full" style="width: 13%"></div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-2.5">
                            <div class="bg-primary-light dark:bg-primary-dark h-2.5 rounded-full" style="width: 10%"></div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="blood-facts-list">
                        <div class="blood-fact mb-4">
                            <div class="flex items-start">
                                <div class="text-primary-light dark:text-primary-light mr-3">•</div>
...
<section class="py-10 md:py-12 bg-transparent-section">
    <div class="container mx-auto px-4">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 md:mb-8">
            ...
            <a href="<?php echo $base_url; ?>camps.php" class="text-primary-light dark:text-primary-light hover:underline font-semibold flex items-center">
