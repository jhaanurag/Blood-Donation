    ...
    <div class="container mx-auto px-4">
        <div class="max-w-md mx-auto bg-white p-8 rounded-lg shadow-md">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="verify_otp.php" class="text-sm text-blue-600 hover:underline">
            ...
            <p class="mb-6 text-gray-600">Please enter your new password below for account <strong><?php echo htmlspecialchars($email); ?></strong>.</p>
